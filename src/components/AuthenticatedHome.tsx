...
import {Calendar, Dumbbell, History, LogOut, Plus, Shield, User} from 'lucide-react';
                ...
                <div className="max-w-md w-full space-y-8 text-center">
                    ...
                    <div className="pt-4 space-y-4">
                        ...
                        <button
                            ...
                            className="w-full max-w-sm mx-auto bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3"
                        >
